...
app.post('/nota', (req, res) => {
    ...
    media = ((pesoAtvLab * atvLab) + (pesoProvaSemestre * provaSemestre) + (pesoTrabalhoTeorico * trabalhoTeorico)) / (pesoAtvLab + pesoProvaSemestre + pesoTrabalhoTeorico);
    ...
    res.render('exercicio2', {resposta: `A média do Aluno é =${media} e a sua classificação é ${classificacao}` })
});
